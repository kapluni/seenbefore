...
const DOC_TIMELINE = [
  ...
  { year: 2005, label: "BDS movement launched, deploying frameworks that echo Soviet-era rhetoric", type: "modern" },
  { year: 2021, label: "B'Tselem, HRW publish apartheid reports echoing language with Soviet-era roots", type: "modern" },
